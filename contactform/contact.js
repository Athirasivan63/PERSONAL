...
function validateName(){
  ...
  if(!name.match(/(^[A-Za-z]{3,16})([ ]{1})([A-Za-z]{3,16}$)/)){
...
function validateSubject(){
 ...
 subjectError.innerHTML=left+'more Charectors Required';
  return false;
  }

subjectError.innerHTML='<t style="color:seagreen;">valid <i class="fa-solid fa-square-check "></i></t>';
return true;
}
